var app = new Vue({
    ...
    data: {
        items: [
		{ id: 'parkinson-canada', format: 'jpg', tags: ['all', 'web', 'branding'], alt: 'Parkinson Canada brand and website evolution' },
            ...
            { id: 'world-junior-team1260', format: 'jpg', tags: ['all', 'graphic', 'branding'], alt: 'World Junior Championship coverage advertisements' },
